...
\begin{figure}
  ...
  \subfloat[Sygnalizator dla pojazdów]{
    \includegraphics[width=0.3\textwidth]{img/models-light-car}
  }
  \hspace{1cm}
  \subfloat[Sygnalizatory dla pieszych]{
    \includegraphics[width=0.3\textwidth]{img/models-light-ped}
  }
...
% LocalWords:  Henzingera stałoczasowym stałoczasowych kompozycjonalny
      optymalizacje opisane w \ref{s:models:opt}% LocalWords:  boolowskiego
      optymalizacje opisane w \ref{s:models:opt}% LocalWords:  wielopotokowych
