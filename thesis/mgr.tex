...
\begin{figure}
  \centering
  \includegraphics[angle=90, width=0.65\textwidth]{img/models-mvmt}
...
\begin{figure}
  \centering
  \vspace*{-2.5cm}
  \includegraphics[angle=90, width=.6\textwidth]{img/models-phasectrl}
...
\begin{figure}
  ...
  \subfloat[Czas weryfikacji.]{
    \includegraphics[width=0.45\textwidth]{img/ver-max-time-chart}
  }
  \hspace{0.5cm}
  \subfloat[Liczba przejrzanych konfiguracji.]{
    \includegraphics[width=0.45\textwidth]{img/ver-max-states-chart}
  }
...
\begin{figure}[ht]
  \centering
  \includegraphics[angle=90, width=0.7\textwidth]{img/models-abstrmvmtctrl}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{img/models-phasectrlf1}
...
\begin{figure}[ht]
  \centering
  \includegraphics[angle=90, width=0.55\textwidth]{img/models-phasectrl1}
